...
def board_block():
    ...
    TYPES = [
        ...
        ("rcdigital", "Реверс-конвертиблы с условным купоном"),
        ("digital", "Купонные варранты"),
    ]
    groups = []
...
def index_blocks():
    ...
    out["rail"] = (
        "<p>Разделы витрины: сотрудничество — условия работы для финансовых институтов и агентов; дайджест инвестиционных идей; разборы тем и компаний; "
