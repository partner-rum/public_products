...
CONFIGS = {
    "ru-market": {
        ...
        "issue": {
            ...
            # Короткая строка для обложки превью: без неё make_og_ideas.py берёт
            # свой запасной текст, а он написан под ИИ-выпуск («от памяти и
            # ускорителей до дата-центров»).
