 ...
 "issues": [
  {
   ...
   "ideas": [
    ...
    },
    {
     ...
     "family": "warrant",
     "kind": "Варрант",
     "name": "Варрант на рост российского рынка",
     "underlying": "Индекс «Румберг Широкий рынок Д» (RWMD)",
     "fx": false,
     ...
     "p": {
      "asset": "Индекс RWMD",
      "price": "188 ₽ · 18,8% ном.",
      "upside": "рост индекса, без потолка",
      "protection": "нет"
     },
     "payoff": {
      "type": "call",
    ...
    },
    {
     ...
     "underlying": "Корзина длинных ОФЗ",
     "fx": false,
     ...
     "p": {
      "asset": "Портфель ОФЗ",
      "price": "по номиналу",
      "upside": "стоимость портфеля + купоны",
      "protection": "нет"
     },
     "payoff": {
      "type": "line"
