# -*- coding: utf-8 -*-
"""
Рисует og-events.png — обложку превью для events.html (1200x630).
...
OUT = os.path.join(ROOT, "og-events.png")
...
def main():
    ...
    if os.path.exists(OUT) and os.path.getsize(OUT) > 8000:
        ...
        print("не забудь поднять ?v= у og:image в events.html — иначе Telegram отдаст старое превью")
    else:
