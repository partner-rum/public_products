...
CONTENTS = [
    ...
    ("Защита",   "Корзина американских акций на энергетику для ИИ", 6),
    ("Купон",    "19% при сохранении или росте цены ОФЗ 26248", 7),
    ("Дисконт",  "Дисконтная облигация на ВЭБ.РФ, 5 лет — 85% дохода", 8),
...
def page_energy():
    ...
    return page(6, "Защита капитала", "Энергетика будущего",
...
def page_coupon():
    ...
    return page(7, "Купон", "Купон на ОФЗ 26248",
...
def page_veb():
    ...
    return page(8, "Дисконт", "Дисконтная облигация<br>на долг ВЭБ.РФ",
...
# ══════════════════════════════════════════════════════════════════════════════
PAGES = [cover(), page_ofz(), page_spy(), page_lkoh(), page_energy(),
         page_coupon(), page_veb(), page_portfolio(), page_legal()]
