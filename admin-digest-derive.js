...
(function (g) {
  ...
  function fromBoard(p) {
    ...
    // Диджитал-варрант НЕ подставляем намеренно. В дайджесте пэйофф с этим именем
    ...
    if (t === "digital") {
      return { supported: false, reason: "Диджитал-варрант в дайджест пока не выводится: график дайджеста рисует диджитал от номинала, а у варрантной формы номинал не возвращается — картинка обещала бы возврат вложенного. Опишите идею вручную или выберите другой продукт." };
    }
