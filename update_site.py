...
#                % номинала), chg, minNom. Заводится руками/админкой (src: "sales").
...
WARRANT_QUOTES = {
    ...
    # Разборы, 19.08.2026: Offer деска, округлённый вверх до 0,25. AMZN деск не дал.
    ("MU", "call", 2): (49.50, 0),   ("MU", "cs", 2): (17.75, 0),
    ("QCOM", "call", 2): (35.25, 0), ("QCOM", "cs", 2): (19.50, 0),
    ("DELL", "call", 2): (61.25, 0), ("DELL", "cs", 2): (24.50, 0),
    ("SMCI", "call", 2): (67.75, 0), ("SMCI", "cs", 2): (23.50, 0),
    ("ORCL", "call", 2): (52.00, 0), ("ORCL", "cs", 2): (22.50, 0),

    ("MU", "call", 3): (62.50, 0),   ("MU", "cs", 3): (22.00, 0),
    ("QCOM", "call", 3): (44.00, 0), ("QCOM", "cs", 3): (23.25, 0),
    ("DELL", "call", 3): (76.50, 0), ("DELL", "cs", 3): (33.50, 0),
    ("SMCI", "call", 3): (84.00, 0), ("SMCI", "cs", 3): (33.25, 0),
    ("ORCL", "call", 3): (64.00, 0), ("ORCL", "cs", 3): (28.25, 0),
}
